...
import com.github.kamicloud.stub.core.interfaces.ResourceInterface;
...
public class ModelStub extends BaseWithAnnotationStub implements ResourceInterface {
    private final LinkedList<ParameterStub> parameters = new LinkedList<>();
    private String parentClasspath;
    private ModelStub parent;

    private final TemplateStub template;
